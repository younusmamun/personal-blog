                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="row g-3" action="{{ route('faqs.store') }}" method="POST"
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="faq_question" class="form-control" id="inputAddress2"
                                    placeholder="">
                            </div>
                            <div class="col-12">
                                <label for="inputAddress2" class="form-label">FAQ Answer </label>
                                <input type="text" name="faq_answer" class="form-control" id="inputAddress2"
                                    placeholder="">
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-check">
                                    <input type="radio" name="status" id="statusYes" class="form-check-input"
                                        value="on" checked>
                                    <label for="statusYes" class="form-check-label">On</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" name="status" id="statusNo" class="form-check-input"
                                        value="off">
