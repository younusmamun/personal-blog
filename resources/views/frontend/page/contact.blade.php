...
<div class="container-xxl py-5">
    <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s">
        <p class="text-head">Feel Free To Contact Us</p>
    </div>
    <div class="container">
        <div class="row g-5">
        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-3 col-sm-6 text-center wow fadeIn" data-wow-delay="0.1s">
                <div class="contact-icon">
                    ...
                    <a href="tel:+880-1752-085374" style="color: #7A8499;">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 text-center wow fadeIn" data-wow-delay="0.1s">
                <div class="contact-icon">
                    ...
                    <h4>Address</h4>
                    <p>Monipuri para,Sangsad Avenue,Dhaka</p>
                </div>
             ...
             <div class="col-lg-3 col-md-3 col-sm-6 text-center wow fadeIn" data-wow-delay="0.1s">
                <div class="contact-icon">
                    <a href="mailto:dreamdiver2017@gmail.com" style="color: #7A8499;">
                        <span><i class="fa fa-envelope" aria-hidden="true"></i></span>
                        <h4>Email</h4>
                        <p>dreamdiver2017@gmail.com</p>
                    </a>
                </div>
             </div>
        </div>
        ...
        <div class="row g-5">
            <div class="col-lg-12 wow fadeIn" data-wow-delay="0.5s" style="min-height: 450px;">
                <div class="position-relative w-100 h-100">
                    ...
                    {{-- <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d912.8896841893261!2d90.38293726949738!3d23.763109998666373!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjPCsDQ1JzQ3LjIiTiA5MMKwMjMnMDAuOSJF!5e0!3m2!1sen!2sbd!4v1709099657364!5m2!1sen!2sbd" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> --}}
